  ...
  experience: [
    {
      ...
      bullets: [
        "Primary architect of a B2B SaaS platform that turns enterprise software initiatives into dependency-aware human-agent execution graphs, then generates specialized AI agent fleets to execute the AI-suited nodes.",
    ...
    <header className={`topnav ${scrolled ? 'scrolled' : ''}`}>
      ...
      <div className={`mobile-menu ${menuOpen ? 'open' : ''}`} aria-hidden={!menuOpen}>
        <nav className="mobile-menu-links">
          ...
          <a href="Deep Dive.html" className="mm-deep"><span>Ventures &amp; Projects</span><span className="arr">↗</span></a>
        </nav>
      </div>
    </header>
  );
  ...
  return (
    <aside className="sidenav">
      ...
      <div className="sidenav-foot">
        <a href="Deep Dive.html" className="sidenav-deep">Ventures &amp; Projects<span className="arr">↗</span></a>
      </div>
    </aside>
  );
}
    ...
    <section id="work" className="section">
      ...
      <Reveal className="deep-cta">
        <a href="Deep Dive.html">
          <span className="deep-cta-title">Ventures &amp; Projects <span className="arr">→</span></span>
        </a>
      </Reveal>
    </section>
  );
