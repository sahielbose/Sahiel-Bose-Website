  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Developed a companion mobile application using React Native and JavaScript to interface with the device, enabling real-time data visualization, alerts, and user interaction for patients and first responders.",
  ...
  return (
    <section id="intro" className="hero">
      ...
      <div className="hero-content">
        ...
        <Reveal delay={0.1}>
          <h1 className="mega">
            <span className="mega-line">Sahiel <span className="mega-italic">Bose</span><span className="mega-dot">.</span></span>
          </h1>
        </Reveal>
