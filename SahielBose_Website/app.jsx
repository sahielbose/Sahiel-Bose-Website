...
const DATA = {
  name: "Sahiel Bose",
  tagline: "UCLA Math + CS '30. Building agentic AI at Optivia and neurotech at ThinkNeuro.",
  email: "sahielbose@g.ucla.edu",
  phone: "(925) 871-8844",
  github: "github.com/sahielbose",
  linkedin: "www.linkedin.com/in/sahiel-bose/",
  about: [
    "I study Math + CS at UCLA. On the side, I co-founded Optivia, an agentic AI workflow, where I oversee and lead the logic, AI architecture, and multi-agent pipelines behind our patent-pending platform.",
  ...
  experience: [
    ...
    },
    {
      ...
      role: "Neurotechnology + Software Engineering Intern",
      location: "Dublin, CA",
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "An AI agent inside Blender that autonomously designs orthopedic implants by iterating geometry against biomechanical stress constraints. Built around a resilient agent loop — every model, tool, and provider call degrades gracefully through a 3-rung fallback ladder so the design loop always returns a valid result.",
    ...
    <section id="intro" className="hero" ref={heroRef}>
      ...
      <div className="hero-content">
        ...
        <Reveal delay={0.3} className="hero-actions">
          <MagneticLink href="#work" className="btn primary" onClick={(e) => { e.preventDefault(); document.getElementById('work').scrollIntoView({ behavior: 'smooth' }); }}>
          ...
          <MagneticLink href={`mailto:${DATA.email}`} className="btn ghost">
